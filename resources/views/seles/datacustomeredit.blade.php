        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <x-splade-form action="{{ route('datacustomerstore') }}" :default="['name'=>$customers->name, 'telephone'=>$customers->telephone, 'address'=>$customers->address, 'paket_id'=>$customers->paket_id, 'ktp'=>$ktp]" class="space-y-4">
