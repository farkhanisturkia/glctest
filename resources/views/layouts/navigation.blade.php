<x-splade-toggle>
    <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex">
                    ...
                    @if (Auth::user()->role == 'admin')
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('datapaket')" :active="request()->routeIs('datapaket')">
                                {{ __('Data Paket') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('dataseles')" :active="request()->routeIs('dataseles')">
                                {{ __('Data Seles') }}
                            </x-nav-link>
                        </div>
                    @elseif (Auth::user()->role == 'seles')
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('datacustomer')" :active="request()->routeIs('datacustomer')">
                                {{ __('Data Customer') }}
                            </x-nav-link>
                        </div>
                    @endif
        ...
        <div v-bind:class="{ block: toggled, hidden: !toggled }" class="sm:hidden">
            ...
            @if (Auth::user()->role == 'admin')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-responsive-nav-link :href="route('datapaket')" :active="request()->routeIs('datapaket')">
                        {{ __('Data Paket') }}
                    </x-responsive-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-responsive-nav-link :href="route('dataseles')" :active="request()->routeIs('dataseles')">
                        {{ __('Data Seles') }}
                    </x-responsive-nav-link>
                </div>
            @elseif (Auth::user()->role == 'seles')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-responsive-nav-link :href="route('datacustomer')" :active="request()->routeIs('datacustomer')">
                        {{ __('Data Customer') }}
                    </x-responsive-nav-link>
                </div>
            @endif
